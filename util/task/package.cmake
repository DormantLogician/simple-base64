...
elseif(CMAKE_HOST_SYSTEM_NAME STREQUAL "Darwin")
    execute_process(COMMAND ${CPACK_EXE} -G "DMG" --config Release/CPackConfig.cmake WORKING_DIRECTORY ${BUILT_DIR}/Release COMMAND_ERROR_IS_FATAL ANY)
    execute_process(COMMAND ${CPACK_EXE} -G "ZIP" --config Release/CPackSourceConfig.cmake WORKING_DIRECTORY ${BUILT_DIR} COMMAND_ERROR_IS_FATAL ANY)
else()
    ...
    execute_process(COMMAND ${CPACK_EXE} --config Release/CPackSourceConfig.cmake WORKING_DIRECTORY ${BUILT_DIR} COMMAND_ERROR_IS_FATAL ANY)
endif()
